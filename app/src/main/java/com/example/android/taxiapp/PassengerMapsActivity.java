...
import com.example.android.taxiapp.databinding.ActivityDriverMapsBinding;
import com.example.android.taxiapp.databinding.ActivityPassengerMapsBinding;
...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void updateLocationUi() {
        if (currentLocation != null) {
            ...
            DatabaseReference passengersGeoFire = FirebaseDatabase.getInstance().getReference().child("passengersGeoFire");
            DatabaseReference passenger = FirebaseDatabase.getInstance().getReference().child("passengers");
